...
function init()
	...
	setOutConfig(FUEL_PUMP_CH,30,1,3000,70)
...
if (( getBat() > 16 ) or (getBat()<7) ) then
     ...
     --   OutSetPWM(FUEL_PUMP_CH,75)

		KeyBoard:setBackLigthBrigth( bright )
				
		Key1Counter:process(KeyBoard:getKey(1),false,false);
		bright = Key1Counter:get()
