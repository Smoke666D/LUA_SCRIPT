...
function Dashboard:process()
	...
	if self.counter > self.repeat_time then
		...
		CanSend( self.ADDR  +2  ,0,0,0,0,0,0,getBatLSB10(),getBatMSB10())
		--CanSend( self.ADDR    ,1,0,getOutStatus(1),getOutStatus(2),getOutStatus(3),getOutStatus(4),getOutStatus(5),getOutStatus(6))
		--CanSend( self.ADDR    ,1,1,getOutStatus(7),getOutStatus(8),getCurLSB10(1),getCurMSB10(1),getCurLSB10(2),getCurMSB10(2))
		--CanSend( self.ADDR    ,1,2,getCurLSB10(3),getCurMSB10(3),getCurLSB10(4),getCurMSB10(4),getCurLSB10(5),getCurMSB10(5))
		--CanSend( self.ADDR    ,1,3,getCurLSB10(6),getCurMSB10(6),getCurLSB10(7),getCurMSB10(7),getCurLSB10(8),getCurMSB10(8))
	--	CanSend( self.ADDR    ,1,4,0,0,0,0,getBatLSB10(),getBatMSB10())
		--CanSend( self.ADDR + 1,1,0,getOutStatus(9),getOutStatus(10),getOutStatus(11),getOutStatus(12),getOutStatus(13),getOutStatus(14))
		--CanSend( self.ADDR + 1,1,1,getOutStatus(15),getOutStatus(16),getCurMSB10(9),getCurLSB10(9),getCurLSB10(10),getCurMSB10(10))
		--CanSend( self.ADDR + 1,1,2,getCurLSB10(11),getCurMSB10(11),getCurLSB10(12),getCurMSB10(12),getCurLSB10(13),getCurMSB10(13))
	--CanSend( self.ADDR + 1,1,3,getCurLSB10(14),getCurMSB10(14),getCurLSB10(15),getCurMSB10(15),getCurLSB10(16),getCurMSB10(16))
		--CanSend( self.ADDR + 1,1,4,0,0,0,0,getBatLSB10(),getBatMSB10())
	--	CanSend( self.ADDR + 2 ,1,0,getOutStatus(17),getOutStatus(18),getOutStatus(19),getOutStatus(20),0,0)
		--CanSend( self.ADDR + 2,1,1,0,0,getCurLSB10(17),getCurMSB10(17),getCurLSB10(18),getCurMSB10(18))
	--	CanSend( self.ADDR + 2,1,3,getCurLSB10(19),getCurMSB10(20),0,0,0,0)
	--	CanSend( self.ADDR + 2,1,4,0,0,0,0,getBatLSB10(),getBatMSB10())
	end
end
