...
function Dashboard:init(PDMName,CH1Name,CH2Name,CH3Name,CH4Name,CH5Name,CH6Name,CH7Name,CH8Name,CH9Name,CH10Name,CH11Name,CH12Name,CH13Name,CH14Name,CH15Name,CH16Name,CH17Name,CH18Name,CH19Name,CH20Name)
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR ,1,10,string.byte(CH2Name,15,16),string.byte(CH3Name,1,4))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR ,1,15,string.byte(CH4Name,13,16),string.byte(CH5Name,1,2))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR ,1,18,string.byte(CH4Name,15,16),string.byte(CH5Name,1,4))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR ,1,23,string.byte(CH7Name,13,16),string.byte(CH8Name,1,2))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR ,1,26,string.byte(CH8Name,15,16),string.byte(PDMName,1,4))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR+1 ,1,7,string.byte(CH9Name,13,16),string.byte(CH10Name,1,2))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR+1 ,1,10,string.byte(CH10Name,15,16),string.byte(CH11Name,1,4))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR+1 ,1,15,string.byte(CH12Name,13,16),string.byte(CH13Name,1,2))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR+1 ,1,18,string.byte(CH13Name,15,16),string.byte(CH14Name,1,4))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR+1 ,1,23,string.byte(CH15Name,13,16),string.byte(CH16Name,1,2))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR+1 ,1,26,string.byte(CH16Name,15,16),string.byte(PDMName,1,4))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR+2 ,1,7,string.byte(CH17Name,13,16),string.byte(CH18Name,1,2))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR+2 ,1,10,string.byte(CH18Name,15,16),string.byte(CH19Name,1,4))
	...
	CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR+2 ,1,15,string.byte(CH20Name,13,16),0,0)
...
function Dashboard:process()
	...
	if self.counter > self.repeat_time then
		...
		CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR    ,1,1,getOut(7),getOut(8),getCurMSB10(1),getCurLSB10(1),getCurMSB10(2),getCurLSB10(2))
		CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR    ,1,2,getCurMSB10(3),getCurLSB10(3),getCurMSB10(4),getCurLSB10(4),getCurMSB10(5),getCurLSB10(5))
		CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR    ,1,3,getCurMSB10(6),getCurLSB10(6),getCurMSB10(7),getCurLSB10(7),getCurMSB10(8),getCurLSB10(8))
		...
		CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR + 1,1,1,getOut(15),getOut(16),getCurMSB10(9),getCurLSB10(9),getCurMSB10(10),getCurLSB10(10))
		CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR + 1,1,2,getCurMSB10(11),getCurLSB10(11),getCurMSB10(12),getCurLSB10(12),getCurMSB10(13),getCurLSB10(13))
		CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR + 1,1,3,getCurMSB10(14),getCurLSB10(14),getCurMSB10(15),getCurLSB10(15),getCurMSB10(16),getCurLSB10(16))
		...
		CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR + 2,1,1,0,0,getCurMSB10(17),getCurLSB10(17),getCurMSB10(18),getCurLSB10(18))
		CanSend(EXT_CAN_ID | 0x0F000000  | self.ADDR + 2,1,3,getCurMSB10(19),getCurLSB10(20),0,0,0,0)
