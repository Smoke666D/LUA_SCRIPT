...
function init()
	...
	OutResetConfig(WIPERS_CH,0,3000)
...
main = function ()
	...
	local CanIn         	= CanInputV1:new(0x28) -- <адрес can>, < таймаут>	
	...
	local OilLevelTimer  	= Delay:new(5000, false)
	...
	while true do		
		...
		--	end
			...
			--	wip_en = wipers_on_delay:process( wipers_on  or location )		
				...
				CanToDash:setBit(3, 4, oil_level or (PreheatTimer < 6000 ))
